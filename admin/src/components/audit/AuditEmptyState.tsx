...
export function AuditEmptyState({ kind, onClearFilter }: Props) {
  if (kind === "filter") {
    return (
  ...
  return (
    <div className="rounded-2xl border border-dashed border-slate-200 bg-white px-6 py-12 text-center">
      <p className="text-[15px] font-semibold text-slate-900">No audit events</p>
      <p className="mx-auto mt-1 max-w-sm text-[13px] text-slate-500">
        Staff logins, reveals, and config changes will appear here once Nest
