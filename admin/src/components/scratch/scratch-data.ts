...
/** Demo prize table — local until Nest API. */
export const SCRATCH_DEMO_ROWS: ScratchPrizeRow[] = [
  {
    id: "gift_coins_50",
    title: "Lucky +50",
  ...
  },
  {
    id: "gift_vault_hint",
    title: "Vault Hint",
    detail: "Cosmetic foil reveal — no real vault prize yet.",
    kind: "GIFT",
    rewardLabel: "FOIL",
    coinReward: 0,
    oddsPercent: 8,
  ...
  {
    id: "gift_jackpot",
    title: "Jackpot Teaser",
    detail: "Rare high-weight tease entry for future real gifts.",
    kind: "GIFT",
  ...
  },
  {
    id: "milestone_30",
    title: "Monthly Elite",
    detail: "Day-30 streak scratch + badge.",
    kind: "MILESTONE",
    rewardLabel: "+150 coins · Badge",
    coinReward: 150,
    oddsPercent: 100,
    enabled: true,
    streakDays: 30,
