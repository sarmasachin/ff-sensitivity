import { WALLETS_CAPABILITIES } from "./wallets-data";
...
export function WalletsCapabilities() {
  return (
    <section className="rounded-2xl border border-[#e8eaee] bg-white p-5">
      ...
      <p className="mt-1 text-[12px] text-[#94a3b8]">
        UI shell now — NestJS wallet + ledger wire-up next.
      </p>
      <ul className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
        {WALLETS_CAPABILITIES.map((item, i) => (
          <li
            key={item.title}
