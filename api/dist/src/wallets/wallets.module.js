...
const wallets_admin_controller_1 = require("./wallets-admin.controller");
...
exports.WalletsModule = WalletsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [wallets_admin_controller_1.WalletsAdminController],
        providers: [wallets_service_1.WalletsService, wallets_module_guard_1.WalletsModuleGuard],
    })
], WalletsModule);
