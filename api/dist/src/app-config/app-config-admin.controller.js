...
exports.AppConfigAdminController = void 0;
...
let AppConfigAdminController = class AppConfigAdminController {
    appConfig;
    ...
    save(admin, dto) {
        if (admin.role === client_1.AdminRole.VIEWER) {
            throw new app_error_1.AppError('FORBIDDEN_ROLE', 'Viewers cannot change App remote config.', 403);
        }
        return this.appConfig.adminSave(admin.id, dto);
    }
};
exports.AppConfigAdminController = AppConfigAdminController;
__decorate([
    (0, common_1.Get)(),
...
], AppConfigAdminController.prototype, "get", null);
__decorate([
    (0, common_1.Put)(),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, app_config_dto_1.SaveAppConfigDto]),
    __metadata("design:returntype", void 0)
], AppConfigAdminController.prototype, "save", null);
exports.AppConfigAdminController = AppConfigAdminController = __decorate([
    (0, common_1.Controller)('api/v1/admin/app'),
...
//# sourceMappingURL=app-config-admin.controller.js.map